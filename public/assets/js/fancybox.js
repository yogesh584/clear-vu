...
!(function (t, e) {
      ...
      function t(e) {
        ...
        o(this, t),
          ...
          (this._pointerEnd = function (t) {
            i._triggerPointerEnd(new P(t), t) &&
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                !1 === this.options[a] ||
                  this.plugins[a] ||
                  ((this.options[a] = S({}, s.defaults || {}, this.options[a])),
                  (e[a] = new s(this)));
              }
      ...
      function n(t) {
        var i,
          a =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        o(this, n),
          ((i = e.call(this, S(!0, {}, M, a))).state = "init"),
          (i.$container = t);
        for (
        ...
        s(n, [
          {
            ...
            value: function () {
              ...
              n ||
                ...
                (i = n).append.apply(i, y(t.childNodes)),
                t.appendChild(n));
          ...
          },
          {
            ...
            value: function (t) {
              var e, n, o, a, s;
              (t
                ? ((e = C(this.transform.x)),
                  (n = C(this.transform.y)),
  ...
  var B = { Navigation: R, Dots: N, Sync: D },
    ...
    H = (function (t) {
      ...
      function n(t) {
        ...
        return (
          (i.slideNext = F(i.slideNext.bind(d(i)), 250)),
          (i.slidePrev = F(i.slidePrev.bind(d(i)), 250)),
          i.init(),
          (t.__Carousel = d(i)),
          i
        );
        ...
        s(n, [
            ...
            value: function () {
              ...
              (this.slides = []),
                ...
                Array.isArray(this.options.slides) &&
                  (this.slides = S(!0, y(this.slides), this.options.slides));
            },
          },
          {
            key: "updateMetrics",
            value: function () {
              ...
              var a = Math.max(
                  ...
                  C(this.$track.getBoundingClientRect().width)
                ),
              ...
              r.forEach(function (t) {
                ...
                g && e.left === g.left
                  ? ((g.width += e.width),
                    (g.slides = [].concat(y(g.slides), y(e.slides))),
                    (g.indexes = [].concat(y(g.indexes), y(e.indexes))))
                  : ((e.index = m.length), (g = e), m.push(e));
              }),
                (this.pages = m);
              var b = this.page;
              if (null === b) {
                ...
                (b =
                  ...
                  m[b] ||
                    (b = m.length && b > m.length ? m[m.length - 1].index : 0),
                  (this.page = b),
                  (this.pageIndex = b);
              }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var o = Math.max(
                  t.offsetWidth,
                  C(t.getBoundingClientRect().width)
                ),
  ...
  var Z = function (t, e) {
      for (
        var i = new URL(t),
          ...
          a = 0,
          s = [].concat(y(n), y(Object.entries(e)));
        a < s.length;
        a++
      ) {
        var r = m(s[a], 2),
                ...
                i ||
                  ...
                  ("html5video" !== i && "video" !== i) ||
                    ...
                    t._width && t._height
                      ...
                      : (t.ratio = t.ratio || t.video.ratio || G.video.ratio));
              }
            },
          },
          {
        ...
        fullscreen: {
          ...
          click: function (t) {
            t.preventDefault(),
              tt.element()
                ? tt.deactivate()
                : tt.activate(this.fancybox.$container);
          },
        },
        slideshow: {
          type: "button",
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                (this.build(),
                this.update(),
                (this.Slideshow = new et(t)),
                !t.Carousel.prevPage &&
                  (t.option("slideshow.autoStart") && this.Slideshow.activate(),
                  t.option("fullscreen.autoStart") && !tt.element()))
              )
                try {
              ...
              value: function (t) {
                ...
                if (void 0 !== o) {
                  ...
                  if ("function" == typeof o)
                    (l = o).call.apply(l, [this, this].concat(s)), g("value");
                  return o;
                }
            ...
            },
            {
              ...
              value: function () {
                ...
                e &&
                  ...
                  this.id ||
                    ((this.id = this.options.id || ++rt),
                    this.$container.setAttribute("id", "fancybox-" + this.id));
                var i,
                  n = this.option("mainClass");
                n &&
                  (i = this.$container.classList).add.apply(i, y(n.split(" ")));
                return (
            ...
            },
            {
              ...
              value: function (t) {
                if (!t.defaultPrevented) {
                  ...
                  if (e.closest(n))
                    e.matches(n) && document.activeElement.blur();
                ...
                if (
                  ...
                  for (
                    var e,
                      ...
                      s = [],
                      r = 0,
                      l = Array.from(n.querySelectorAll(q));
                    r < l.length;
                    r++
                  ) {
                    var c = l[r],
                  ...
                  t
                    ...
                    ? U(e)
                    : s.indexOf(document.activeElement) < 0 && U(n),
            ...
            },
            {
              ...
              value: function (t) {
                var e =
                  ...
                  s = e.target || null,
                  r =
                    void 0 !== (e = S({}, e, i.openers.get(t))).groupAll &&
                    e.groupAll,
  ...
  (lt.version = "4.0.25"),
    ...
    (lt.openers = new Map()),
    (lt.Plugins = ot),
    lt.bind("[data-fancybox]");
  for (
    var ct = 0, ht = Object.entries(lt.Plugins || {});
    ct < ht.length;
    ct++
  ) {
    var dt = m(ht[ct], 2);
