            ...
            s = this.each(function() {
                ...
                !this.sumo && e(this).is("select") && (this.sumo = {
                    ...
                    createLi: function(t, l) {
                        ...
                        var subText = (t.attr("data-subText") ? t.attr("data-subText") : '');
                        var iconimg = (t.attr("data-iconimg") ? t.attr("data-iconimg") : '');
                        var dataAnchor = (t.attr("data-anchor") ? t.attr("data-anchor") : '');
                        var dataCreateNewGroup = (t.attr("data-create-group") ? t.attr("data-create-group") : '');
                        
                        
                        /* added icon and text named extra content */
                        var extraContent = ""; 
                        if( subText != "" )
                        {
                            extraContent += "<em class='suspend_text'>"+subText+"</em>";
                        } 
                        if( iconimg != "" )
                        {
                            if( dataAnchor != "" ){
                                extraContent += "<div class='extra_content_icon'><a target='_blank' href='"+dataAnchor+"'><img src='"+iconimg+"'/></a></div>";
                            }else{
                                 extraContent += "<div class='extra_content_icon'><img src='"+iconimg+"'/></div>";
                            }
                        }  
                        
                        if( dataAnchor != "" )
                        {
                             var s = e('<li class="opt"><label><a target="_blank" href="'+dataAnchor+'">' + t.text()+"</a>"+ extraContent +"</label></li>");
                        }else{
                             var s = e('<li class="opt"><label>' + t.text() + extraContent +"</label></li>");
                        }
                        if( dataCreateNewGroup != "" && dataCreateNewGroup == "yes" )
                        {
                             var s = e('<li class="opt newClassForCreateGroupOpt" onclick="show_modal_for_add_new_group();"><label>' + t.text() + extraContent +"</label></li>");
                        }else{
                             var s = e('<li class="opt"><label>' + t.text() + extraContent +"</label></li>");
                        }
                        /* added icon and text */
